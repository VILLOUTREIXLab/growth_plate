function [] = characteristics_on_grid_cells(all_cells,opt,gp)
%CHARACTERISTICS_ON_GRID_CELLS Computes aggregated cells features on a 3D
%grid
%   Input: all individual cells features
%   Output: aggregated cells features on 3D grid
...
spatial_profiles = features_3D_grid(grid_sp,all_cells,2);
